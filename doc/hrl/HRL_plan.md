...
|---|---|---|---|
| **A0** | `Unitree-H1_2-Flat` | ✅ v1 done; **v2 baseline running** (2026-07-08) | Flat PPO baseline. v1 benchmark ref err_vx/vy/yaw 0.09/0.11/0.10 (v1 env only). **Model v2** (arm hold gains + split deploy, `docs/adr/0005` + amendment) invalidates all v1 checkpoints; fresh 10k `a0_v2_baseline` (exp `h1_2_velocity_v2`) training; gate = benchmark + v1/v2 cross-eval + C++ bridge full-vs-split. |
